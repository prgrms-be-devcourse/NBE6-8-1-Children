...
public class ShoppingBasketController {
    ...
    public ShoppingBasketDto createShoppingBasket(@RequestBody ShoppingBasketDto dto, @AuthenticationPrincipal SecurityUser userDetails) {
        ShoppingBasketDto shoppingBasketDto = shoppingBasketService.createShoppingBasket(dto, userDetails.getId());
