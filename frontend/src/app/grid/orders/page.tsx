...
export default function OrderPage() {
  ...
  useEffect(() => {
    axios.get<OrderPageResponse>('/order/basket/me') // 해당 API로 서버에 GET요청. memberId는 토큰?으로 추출(Rq에 getActor()로)
      .then(res => {
        setAddress(res.data.address); //서버가 보낸 응답데이터에서 주소 추출
